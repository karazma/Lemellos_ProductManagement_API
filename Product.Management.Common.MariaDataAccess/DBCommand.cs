...
namespace Product.Management.Common.MariaDataAccess
{
    public class DBCommand
    {
        ...
        public DBCommand(string txtConnectionString)
        {
        ...
        private void OpenDatabase()
        {
            ...
            {
                throw new Exception("An unexpected error occurred in clsDBCommand.OpenDatabase w/ connection string: '" + m_txtConnectionString + "', see inner exception for details.", e);
            }
        }
        private void CloseDatabase()
        {
            ...
            {
                throw new Exception("An unexpected error occurred in clsDBCommand.CloseDatabase, see inner exception for details.", e);
            }
        }
        public void BeginTransaction()
        {
            if (m_transaction != null)
                throw new Exception("clsDBCommand.BeginTransaction: A transaction is already in progress.");
            ...
            {
                throw new Exception("An unexpected error occurred in clsDBCommand.BeginTransaction, see inner exception for details.", e);
            }
        }
        ...
        public void CommitTransaction()
        {
            ...
            {
                throw new Exception("An unexpected error occurred in clsDBCommand.CommitTransaction, see inner exception for details.", e);
            }
        }
        public void RollbackTransaction()
        {
            ...
            {
                throw new Exception("An unexpected error occurred in clsDBCommand.RollbackTransaction, see inner exception for details.", e);
            }
        }
        ...
        public void AddParameter(string txtParamName, DbType paramType, object paramValue)
        {
            ...
            if (m_parameters.Contains(newParm))
                throw new Exception("clsDBCommand.AddParameter: Parameter already exists.");
            else
        ...
        public DataSet ExecuteCommand()
        {
            ...
            catch (System.Exception e)
            {
                ...
                throw new Exception("An unexpected error occurred in clsDBCommand.DataTable.ExecuteCommand(), see inner exception for details.", e);
            }
            finally
            {
                if (cmd != null)
        ...
        public int ExecuteNonQuery()
        {
            ...
            catch (System.Exception e)
            {
                ...
                throw new Exception("An unexpected error occurred in clsDBCommand.DataTable.ExecuteNonQuery(), see inner exception for details.", e);
            }
            finally
            {
                if (cmd != null)
